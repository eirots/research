...
pub enum ContinuationFrame {
    EvaluateFunctionThenApplyArgument {
        arugment_expression: Expression,
        argument_environment: Environment,
    },
    EvaluateArgumentThenApplyFunction {
        function_value: Value,
    },
}

#[derive(Clone, Debug)]
pub struct Environment(Rc<HashMap<String, Value>>);
...
pub struct MachineState {
    control: Expression,
    environment: Environment,
    continuation: Vec<ContinuationFrame>,
}
